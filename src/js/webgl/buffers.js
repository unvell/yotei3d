...
export class FrameBuffer extends CommonBuffer {
	constructor(renderer,
...
export class CubeMapFrameBuffer extends CommonBuffer {
	constructor(renderer, width, height, backColor) {
		super(renderer, width, height, backColor);

		const gl = this.gl;
		
		const cubemap = new CubeMap(this.renderer);
...
export class StencilBuffer extends CommonBuffer {
	constructor(renderer) {
		super(renderer)
	}
